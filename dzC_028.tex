...
Переделайте следующие программы на язык C++.

\begin{enumerate}
 \item 2 программы на форматированный вывод.
 \item Динамический массив.
 \item Динамическая структура.
 \item Работа с файлом.
 \item Функции вычисляющие НОК и НОД сделать шаблонными.
\end{enumerate}
